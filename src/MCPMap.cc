...
MCPList.insert(std::make_pair("MiB2",0));
      MCPList.insert(std::make_pair("Plana1",1));
      MCPList.insert(std::make_pair("Plana2",2));
      MCPList.insert(std::make_pair("Plana3",3));
      MCPList.insert(std::make_pair("Plana4",4));
    }
...
inverted_MCPList.insert(std::make_pair(0,"MiB2"));
      inverted_MCPList.insert(std::make_pair(1,"Plana1"));
      inverted_MCPList.insert(std::make_pair(2,"Plana2"));
      inverted_MCPList.insert(std::make_pair(3,"Plana3"));
      inverted_MCPList.insert(std::make_pair(4,"Plana4"));
    }
